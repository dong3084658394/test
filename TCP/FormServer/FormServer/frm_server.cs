    ...
    public partial class frm_server : Form
    {
        ...
        void WatchConnecting()
        {
            while (true)  // 持续不断的监听客户端的连接请求；  
            {
                ...
                // 想列表控件中添加客户端的IP信息；  
                lbMsgClient.Items.Add(sokConnection.RemoteEndPoint.ToString());
        ...
        void RecMsg(object sokConnectionparn)
        {
            ...
            while (true)
            {
                ...
                catch (SocketException se)
                {
                    ...
                    // 从列表中移除被中断的连接IP  
                    lbMsgClient.Items.Remove(sokClient.RemoteEndPoint.ToString());
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            string strKey = lbMsgClient.Text.Trim();
            ...
            {
                dict[lbMsgClient.Items[0].ToString()].Send(arrSendMsg);// 解决了 sokConnection是局部变量，不能再本函数中引用的问题；  
                ShowMsg(strMsg);
                txtMsgSend.Clear();
            }
        ...
        void sendData() {
            while (true) {
            string strMsg = "#0270091290|02|00|(1,0,1.5)|"+DateTime.Now.ToString()+ "|\r\n#0270091290|02|00|(1,0,1.5)|" + DateTime.Now.ToString() + "|\r\n#0270091290|02|00|(1,1,1.5)|2016-12-12 17:28:30|\r\n#0270091290|02|00|(1,2,1.5)|" + DateTime.Now.ToString() + "|\r\n";
            byte[] arrMsg = System.Text.Encoding.UTF8.GetBytes(strMsg); // 将要发送的字符串转换成Utf-8字节数组；  
            byte[] arrSendMsg = new byte[arrMsg.Length + 1];
            arrSendMsg[0] = 0; // 表示发送的是消息数据  
            Buffer.BlockCopy(arrMsg, 0, arrSendMsg, 1, arrMsg.Length);
        ...
        {
         bool rel=   Regex.IsMatch("143795e8686", @"^(-?\d+[.]?\d+)$");
        }
    }
}
